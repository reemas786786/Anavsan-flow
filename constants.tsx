...
export const IconClipboardCopy: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75m9-1.125a2.25 2.244 2.077H9.375a2.25 2.244 2.077 0 00-2.25 2.25v9.75" />
...
export const accountNavItems = [
    ...
    { name: 'Credit trend', icon: IconTrendingUp, children: [] },
    { 
        name: 'Warehouses', 
        icon: IconLayers, 
        children: [] 
