                        ...
                        <div className="bg-indigo-50/50 p-6 rounded-[24px] border border-indigo-100 space-y-4 relative group">
                            ...
                            {!isPromptGenerated ? (
                                <div className="flex flex-col items-center justify-center py-4 space-y-4">
                                    <p className="text-sm text-indigo-900/60 font-medium text-center max-w-md">
                                ...
                                <>
                                    <div className="bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-indigo-100 text-sm text-indigo-900/70 leading-relaxed font-medium italic animate-in fade-in slide-in-from-top-2 duration-300">
